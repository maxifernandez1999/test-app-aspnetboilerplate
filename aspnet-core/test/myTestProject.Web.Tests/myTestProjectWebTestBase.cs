...
{
    public abstract class myTestProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static myTestProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(myTestProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<myTestProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<myTestProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<myTestProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<myTestProjectDbContext, Task<T>> func)
        {
            T result;
